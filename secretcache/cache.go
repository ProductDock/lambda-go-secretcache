...
// New constructs a secret secretcache using functional options, uses defaults otherwise.
// Initialises a SecretsManager Client from a new session.Session.
// Initialises CacheConfig to default values.
// Initialises lru secretcache with a default max size.
...
// GetSecretString gets the secret string value from the secretcache for given secret id and a default version stage.
...
// GetSecretStringWithStage gets the secret string value from the secretcache for given secret id and version stage.
// Returns the secret string and an error if operation failed.
...
// GetSecretBinary gets the secret binary value from the secretcache for given secret id and a default version stage.
...
// GetSecretBinaryWithStage gets the secret binary value from the secretcache for given secret id and version stage.
// Returns the secret binary and an error if operation failed.
