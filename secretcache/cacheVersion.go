...
// cacheVersion is the secretcache object for a secret version.
type cacheVersion struct {
	versionId string
	*cacheObject
}

// newCacheVersion initialises a cacheVersion to secretcache a secret version.
func newCacheVersion(config CacheConfig, client SecretsManagerAPIInterface, secretId string, versionId string) cacheVersion {
	return cacheVersion{
		versionId:   versionId,
